...
try:
    from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLRMSNorm as _QWEN25_VL_RMSNORM
except ImportError:
    from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2RMSNorm as _QWEN25_VL_RMSNORM
...
_QWEN25_VL_RMSNORM.forward = rms_norm_forward
