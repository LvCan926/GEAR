...
from verl.utils.device import get_device_id, get_device_name, get_distributed_backend, get_hf_attn_kwargs, get_nccl_backend, get_torch_device, is_cuda_available, is_npu_available
...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        if not torch.distributed.is_initialized():
            ...
            torch.distributed.init_process_group(
                backend=get_distributed_backend(include_cpu=True),
                rank=rank,
    ...
    def _build_model_optimizer(
        ...
        actor_model_config = AutoConfig.from_pretrained(local_path, trust_remote_code=trust_remote_code, **get_hf_attn_kwargs())
...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        critic_model_config = AutoConfig.from_pretrained(local_path, trust_remote_code=config.model.get("trust_remote_code", False), **get_hf_attn_kwargs())
